...
public class Map_importer : AssetPostprocessor {
	private static readonly string filePath = "Assets/Map.xls";
	private static readonly string exportPath = "Assets/Map.asset";
